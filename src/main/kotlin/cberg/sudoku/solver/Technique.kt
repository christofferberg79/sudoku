...
sealed interface Technique {
    ...
    class NakedTuple(private val n: Int, private val positions: List<Position>, private val values: Set<Char>) : Technique {
        override fun toString(): String {
            return "Naked ${tupleString(n)} $values at $positions"
        }
    }
    class HiddenTuple(private val n: Int, private val positions: List<Position>, private val values: Set<Char>) : Technique {
        override fun toString(): String {
            return "Naked ${tupleString(n)} $values at $positions"
        }
    }
